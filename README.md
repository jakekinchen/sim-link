...
## Active SO-101 Robotics Program

Alongside the published SceneSmith scene-generation project, this checkout hosts
an active SO-101/MuJoCo/LeRobot program with strict provenance, grasp
...
- [Testing](#-testing)
- [Active SO-101 Robotics Program](#active-so-101-robotics-program)
- [License](#-license)
