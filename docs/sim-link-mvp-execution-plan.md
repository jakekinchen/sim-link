...
| 20b | **T20.43b — R1 ACT replacement rung (epoch-2 refresh implementation accepted; Briefs 222/225, Reviewers 299/301/302/304)** | Spec `13c5bb4b...` preserves the original fixed 10,000-update recipe. Acceptance commit `5f2abf3` is exact on origin, but Reviewer 302 stopped before the marker. Reviewer 304 accepts a separately named refresh wrapper that preserves epoch 1, replacement/attempt ordinal 1, and all recipe/output paths; only model-free epoch-2 materialization opens after origin. | Verified T20.44 terminal boundary; owner addendum `8b4a206`; owner resolve direction; Reviewers 299/301/302/304 | Stale-permit reuse, second replacement or attempt, retry, recipe changes, correction objectives, marker without reviewed epoch-2 authority, threshold changes, hardware, network, external compute, Brev |
