...
| 20b | **T20.43b — R1 ACT replacement rung (owner-authorized, opens after T20.44 terminal boundary)** | One replacement attempt per the recorded owner addendum in [`owner-route-decision-2026-07-16-t20-41.md`](./autonomous-workflow/owner-route-decision-2026-07-16-t20-41.md): stable T20.44 runtime plus renderer smoke gate, same fixed 10,000-update recipe lineage `b3a510f8...`, fresh brief/authority/preflight/one-use permit, T20.36j precedent. Supersedes T20.43's no-replacement exclusion for exactly one attempt. | T20.44 terminal boundary on origin; recorded owner replacement authorization | Second replacement, recipe changes, correction objectives, threshold changes, hardware, network, external compute, Brev |
| 21 | **T20.44 — R2 SmolVLA standard rung (active; Brief 220/Reviewer 296)** | Stable authority `37ae581` and acceptance `6e84de9e...` bind one cached-base batch-8/5k run with official AdamW/cosine, stable exact-interpreter renderer, checkpoints `[0,500,1000,2500,5000]`, and chunk-50/receding-10 strict-v2 evaluation. Run opens after acceptance origin preservation. | Verified T20.42; T20.43 boundary; Reviewers 294-296 | Retry/replacement, correction objectives, network/download, Gate B/open-loop barrier, threshold changes, hardware, external compute, Brev |
