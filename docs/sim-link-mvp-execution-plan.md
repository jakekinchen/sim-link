...
| 13o | **T20.36o — bounded X episode-0 bridge design/authority (design verified; baseline authority next)** | Design `b44bd55b...` freezes `n_action_steps=50`, one reset, starts 0/50/100/150/200, lengths 50/50/50/50/44, all episode-0 records, and a six-action tail mask. Its strict frozen-gate envelope and update-0 probe can skip training; a failure retains 250 paths before any separate 2,500-update-ceiling authority. | Verified T20.36n; owner overnight priority 3; Brief 208; Reviewer 267 | Model load/inference before reviewed one-use permit, optimizer/training before a retained baseline failure and separate authority, Gate C rollout, threshold change, new candidate, hardware, external compute, Brev |
