...
| 13j | **T20.36j — corrected SmolVLA replacement attempt (preflight/permit verified; sole attempt next)** | Closure `ac8abed1...`, processor smoke `5223d8f0...`, corrected preflight `3c9b5af9...`, and one-use permit `effa3b65...` are preserved on origin. Run exactly one local-MPS counted replacement under the frozen evaluator/schedule and unchanged 0.10/0.05 Gate B. | Verified T20.36j-B; owner authorization 2026-07-16; Brief 203; Reviewers 255-259 | Second attempt; retry/sweep; gate change; Gate C before Gate B pass; hardware; external compute; Brev |
