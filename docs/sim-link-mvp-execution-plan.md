...
| 20b | **T20.43b — R1 ACT replacement rung (pre-run accepted, unconsumed; Brief 222/Reviewers 299/301/302)** | Spec `13c5bb4b...` preserves the original fixed 10,000-update recipe. Acceptance commit `5f2abf3` is exact on origin, but Reviewer 302 stops before the marker because no measured evidence proves the noninterruptible campaign fits the remaining hard-close budget. The replacement remains unconsumed; next window refreshes administrative authority only after proving marker absence. | Verified T20.44 terminal boundary; owner addendum `8b4a206`; Reviewers 299/301/302 | Stale-permit reuse, second replacement, retry, recipe changes, correction objectives, marker without a fresh safe window, threshold changes, hardware, network, external compute, Brev |
