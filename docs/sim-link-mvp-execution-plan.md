...
| 20 | **T20.43 — R1 ACT standard rung (active; Brief 219/Reviewer 292)** | Implementation `9a03a86` and compact authority `2f2a2ca` are origin-preserved; signed acceptance `7d742980...` opens one full official ACT run after its own origin preservation: 10k updates, batch 8, fixed checkpoints `[0,500,1000,2500,5000,7500,10000]`; rollout-primary episode-0 strict-v2 evaluation under chunk-50 and receding-10; retain the first mechanical Gate C pass immediately with full trace, mirror MP4, manifest, and scorecard. | Verified T20.42/Reviewer 290; Brief 219; Reviewer 292 | Model or optimizer action before acceptance origin confirmation, correction objectives, retry, Gate B entry barrier, open-loop entry barrier, threshold changes, hardware, external compute, Brev |
