...
| 20b | **T20.43b — R1 ACT replacement rung (pre-run accepted; Brief 222/Reviewers 299/301)** | Spec `13c5bb4b...` preserves the original fixed 10,000-update recipe exactly. Authority commit `5f8a31e` binds stable smoke `35224058...`, Gate A `ea65f3d1...`, central decision `3b534f91...`, runtime `549c0db2...`, and sole permit `c7e8e1ca...`; acceptance `525de8dc...` must be exact on origin before the marker. | Verified T20.44 terminal boundary; owner addendum `8b4a206`; Reviewers 299/301 | Second replacement, retry, recipe changes, correction objectives, marker before acceptance origin, threshold changes, hardware, network, external compute, Brev |
