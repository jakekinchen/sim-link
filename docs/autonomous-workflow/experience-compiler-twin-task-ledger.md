...
current_task: T20.17 in progress under documentation-only Brief 146: the accepted MVP cut restores the immediate target to clean pi05_base dataset-native training and strict-v2 evaluation; T20.18-T20.22 are dependency-ordered pending sim-link tasks; Robo Scan I4 remains a separate external dependency
