...
| T19.2 | in_progress | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | Brief 213/Reviewer 283 readiness `5476d01d...`; Brief 214/Reviewer 284 target spec/PDF verified; Brief 215 now implements the offline sub-degree watchdog/deadman/stop/exact-return harness; target print/placement and a separate central live permit still remain |
