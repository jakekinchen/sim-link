...
run_state: T20.19 is verified through Brief 150 and Reviewer Decision 180. T20.20 is active under Brief 151 with one shared strict-v2 predicate vocabulary and fail-closed privileged/observable roles.
current_milestone: M20 simulation-only clean supervision
current_task: T20.20 in progress under Brief 151: privileged-versus-observable evaluator role contract
...
remaining: T20.20-T20.22 observer-role evaluation, paired traces, and timing evidence; T19.2 physical calibration remains under fresh permits
...
next_step: implement tests-first role separation and a deterministic simulator consistency report; do not use privileged fields in an actor or observable evaluator
```
