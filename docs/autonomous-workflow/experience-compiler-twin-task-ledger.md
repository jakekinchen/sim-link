...
run_state: T20.15 is in progress under Brief 135; no-optimizer 2x2 state-token versus action-postprocessor normalizer ablation at the identical seed-2 reset
current_milestone: M20 simulation-only clean supervision
current_task: T20.15 in progress: isolate state-token normalization from action-target/postprocessor normalization with a no-optimizer 2x2 frame-zero ablation
...
| T20.15 | in_progress | T20.14 | Isolate PI0.5 state-token versus action-postprocessor normalizer effects | Brief 135; no optimizer; 2x2 old/new state and action normalization at the identical seed-2 reset |
