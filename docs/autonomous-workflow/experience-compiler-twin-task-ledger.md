...
| T19.2 | in_progress | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | Brief 213/Reviewer 283 readiness `5476d01d...`; Brief 214/Reviewer 284 printable target spec `6359a62f...` and PDF `02af20f0...` verified/rendered; physical print/placement remains, and T19.2b next builds watchdog/deadman/stop/exact-return harness before any live gate |
