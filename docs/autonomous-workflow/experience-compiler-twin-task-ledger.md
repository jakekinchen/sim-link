...
run_state: T20.6 in progress under Brief 126; binding truthful terminal outcomes to the existing strict-v2 ordered capability witness
current_milestone: M20 simulation-only clean supervision
current_task: T20.6 in progress under Brief 126: run fixed phase-level and adversarial outcome-versus-strict evaluation
...
remaining: T20.6 adversarial semantic evaluation, then T20.7 model bake-off; T19.2 physical calibration remains under fresh permits
...
next_step: implement and verify the signed deterministic T20.6 fixture, preserving truthful target occupancy while required adversarial cases fail strict success
```
...
| T20.6 | in_progress | T20.2-T20.5 | Run fixed one-cube phase-level and adversarial outcome-versus-strict evaluation | Brief 126; ordered approach/contact/grasp/lift/transport/placement/release/retreat witness; putt, slide, throw, terminal-occupancy-only, scripted-motion, assistance-relabel, stage-drift, and actor-privilege cases preserve truthful outcomes but fail strict success |
