...
current_task: T20.17 in progress: the requested bespoke-versus-package recreation map and documentation information architecture are verified; the separate next task is a fresh source-backed clean-base campaign, never a conversion of legacy parallel storage
