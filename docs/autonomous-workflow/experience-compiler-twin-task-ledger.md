...
run_state: T20.18 is verified through Brief 149 and Reviewer Decision 179: exact candidate replay captured 244 states; eight deterministic branches produced four recoveries, two near-failures, and two failures; 1,290 frames and 2,580 observations are retained.
current_milestone: M20 simulation-only clean supervision
current_task: T20.19 pending brief: small discrete uncertainty ensemble around the proven recovery branches
...
remaining: T20.19-T20.22 discrete ensemble, observer-role evaluation, paired traces, and timing evidence; T19.2 physical calibration remains under fresh permits
...
next_step: open a narrow T20.19 discrete-ensemble brief; do not infer a calibrated posterior or start optimizer work
```
