...
run_state: T20.4 opened under Brief 124 for the 250-update local-MPS rung; physical transfer and promotion remain closed
current_milestone: M20 simulation-only clean supervision
current_task: T20.4 in progress under Brief 124: add exact optimizer-update and accumulation accounting, then run and evaluate the bounded 250-update local-MPS rung
...
next_step: implement explicit microbatch/accumulation accounting, test it fail-closed, and run the immutable 250-optimizer-update rung before considering 500 or 1,000 updates
```
...
| T20.4 | in_progress | T20.2-T20.3 | Add explicit accumulation and run 250/500/1,000 optimizer-update MPS ladder | Brief 124; begin with 250 optimizer updates and two microbatches per update; larger rungs require reviewed evidence |
