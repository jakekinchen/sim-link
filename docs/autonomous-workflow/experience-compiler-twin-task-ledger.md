...
run_state: T20.14 is in progress under Brief 134; exact 20-sample local-MPS PI0.5 retrain and fixed seed-2 strict evaluation
current_milestone: M20 simulation-only clean supervision
current_task: T20.14 in progress: bounded local-MPS PI0.5 retrain with the frozen train-only normalizer, equal loss weights, common samples, and fixed seed-2 closed loop
...
| T20.14 | in_progress | T20.13 | Retrain PI0.5 with frozen dataset-bound normalization and equal loss weights | Brief 134; bounded local-MPS common-sample rung plus fixed seed-2 strict closed loop and five keyframes |
