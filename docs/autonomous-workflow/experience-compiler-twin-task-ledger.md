...
run_state: T20.27 is verified through Brief 158 and Reviewer Decision 188; Brief 159 opens T20.28 for exact clean/recovery sampler-order and phase-exposure reconstruction.
current_milestone: M20 simulation-only clean supervision
current_task: T20.28 in progress under Brief 159; exact official sampler exposure by episode source and phase
...
next_step: tests-first sampler audit, actual pinned EpisodeAwareSampler replay, then signed exposure comparison
```
