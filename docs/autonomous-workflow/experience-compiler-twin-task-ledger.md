...
run_state: T20.28 is verified through Brief 159 and Reviewer Decision 189; Brief 160 opens T20.29 for a five-seed clean/recovery action-quantile postprocessor counterfactual.
current_milestone: M20 simulation-only clean supervision
current_task: T20.29 in progress under Brief 160; hold normalized outputs fixed and cross-decode clean/recovery action quantiles
...
next_step: tests-first quantile counterfactual, exact package formula and stats binding, then signed paired result
```
