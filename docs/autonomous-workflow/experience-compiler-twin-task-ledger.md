...
current_task: T18.4 pending after verified T18.3; implement immutable snapshot branch-and-correct without training
...
next_step: implement T18.4 immutable snapshot branch-and-correct linked by correction_event_id, with training authority closed
```
