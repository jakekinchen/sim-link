...
| T19.2 | in_progress | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | Brief 213/Reviewer 283; readiness `5476d01d...` binds four existing local facts and names eight missing prerequisites; Brief 214 first builds the exact printable metric target, then the watchdog/deadman/stop/exact-return harness remains before any live gate |
