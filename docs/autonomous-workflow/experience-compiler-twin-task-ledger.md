...
current_task: F0 in_progress under Brief 230; deterministic model-free release-gap diagnosis only
...
next_step: implement and verify the exact sampler/padding, normalization, release-mixture, and physical-L1 gripper audit before routing or rejecting one corrective ACT proposal
```
