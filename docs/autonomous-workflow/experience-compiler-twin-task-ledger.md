...
| T19.2 | in_progress | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | Brief 213 builds the offline source-bound readiness matrix first; separate target/harness implementation, central motion decision, exact bounded plan, runtime preflight, and finite permit remain required before held-out reprojection/pose/timing work |
