...
run_state: T20.28 is verified through Brief 159 and Reviewer Decision 189: recovery had more approach/frame-zero exposure than clean, rejecting low early-phase exposure.
current_milestone: M20 simulation-only clean supervision
current_task: T20.28 verified sampler audit; next safe task is recovery-mixture quantile/postprocessor shift audit
...
next_step: compare clean and recovery dataset action quantiles and frame-zero postprocessor consequences without model execution
```
