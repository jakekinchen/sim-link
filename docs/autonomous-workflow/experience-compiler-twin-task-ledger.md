...
current_task: T20.35b in progress under Brief 168 for a source-grounded PI0.5 coverage semantic correction before the no-LoRA capacity ceiling
...
next_step: correct the signed coverage audit against PI0.5's real action/time modules and intentional lack of state_proj; run no model or optimizer
```
