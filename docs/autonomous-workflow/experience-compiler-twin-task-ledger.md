...
| T19.2 | pending | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | T19.1 now verified; separate reviewed central motion decision, exact bounded plan, runtime preflight, and finite permit required before held-out reprojection/pose/timing work |
