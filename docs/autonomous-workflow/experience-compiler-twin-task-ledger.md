...
| T19.2 | in_progress | T19.1, motion authority | Calibrate cameras, joint offsets, kinematics, timing, and gripper aperture | Brief 213/Reviewer 283; readiness `5476d01d...` binds four existing local facts and names eight missing prerequisites; T19.2a next builds the metric-target and watchdog/deadman/stop/exact-return harness offline before any live gate |
