...
| Robo Scan integration | Treat the modular scan/scene/calibration repository as an explicit immutable artifact source, not a runtime dependency; preserve its local authority boundary. | [Robo Scan integration boundary](./robo-scan-integration.md) and [Brief 143](./briefs/143-robo-scan-handoff-boundary.md) |
