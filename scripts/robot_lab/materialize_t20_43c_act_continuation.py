#!/usr/bin/env python3
"""Materialize the reviewed model-free T20.43c continuation authority."""
...
from scenesmith.robot_lab.t20_43c_act_continuation_materialization import (  # noqa: E402
...
def main() -> int:
    ...
    if args.verify:
        ...
        if not all((args.required_source_commit, args.valid_from, args.valid_until)):
            parser.error(
                "materialization requires source commit, valid-from, and valid-until"
            )
