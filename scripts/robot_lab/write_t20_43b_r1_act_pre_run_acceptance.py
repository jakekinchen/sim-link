#!/usr/bin/env python3
"""Write or verify signed Reviewer acceptance for the sole T20.43b attempt."""
...
def main() -> int:
    ...
    if args.verify:
        ...
        if not reviewer.is_file() or reviewer.is_symlink():
            raise FileNotFoundError("T20.43b reviewer decision is absent or aliased")
        ...
        if (REPO_ROOT / PRE_RUN_ACCEPTANCE_PATH).exists():
            raise FileExistsError("T20.43b pre-run acceptance already exists")
