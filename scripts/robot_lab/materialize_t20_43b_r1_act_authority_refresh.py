#!/usr/bin/env python3
"""Materialize or verify the T20.43b epoch-2 administrative authority."""
...
def main() -> int:
    ...
    if args.verify:
        bundle = verify_refresh_authority(repo_root=REPO_ROOT)
    else:
        ...
        bundle = materialize_refresh_authority(
