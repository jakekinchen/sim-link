...
from scenesmith.robot_lab.t20_35r_simulation_training_authority import (
    build_owner_grant,
    verify_authority,
    verify_owner_grant,
)
...
class T2035rFullPathSelfConsistencyCorrectionTests(unittest.TestCase):
    @classmethod
    ...
    def test_result_requires_both_objective_and_action_gate(self) -> None:
        ...
        self.assertEqual(
            ...
            "full_path_objective_pass_action_fail_route_iterated_self_consistency_audit",
        )
        ...
        self.assertEqual(
            ...
            "action_pass_full_path_objective_fail_route_objective_floor_audit",
        )
