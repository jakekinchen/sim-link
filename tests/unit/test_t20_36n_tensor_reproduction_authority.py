...
class T2036nTensorReproductionAuthorityTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.sources = load_verified_sources()

    def test_owner_grant_is_one_use_inference_only(self) -> None:
        ...
        self.assertEqual(grant["inference_seed_count"], 5)
        self.assertEqual(grant["repeats_per_seed"], 2)
