...
class T2043bR1ACTRunnerTest(unittest.TestCase):
    ...
    def test_terminal_failure_is_one_replacement_and_tamper_evident(self) -> None:
        progress = {
            "stage": "optimizer_training",
        ...
        self.assertFalse(failure["second_replacement_authorized"])
